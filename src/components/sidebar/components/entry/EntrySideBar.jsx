...
const EntrySideNavBar = ({ userData, date, setDate, canRequest, setLoggedIn, isLessWidth, visibleMenu, setVisibleMenu }) => {
    ...
    return (<div className="flex min-h-screen">
        ...
        <aside className={`
                              ...
                              sm:w-20 md:w-48 lg:w-55
                              min-h-screen
                              ${visibleMenu ? "visible w-20" : "hidden sm:block"}
                              `}>
            {
                (visibleMenu) ? (
                    <motion.div>
        ...
        <div className='flex-1 flex flex-col'>
            ...
            <div className='m-1 rounded-sm'>
                <Header userData={userData} date={date} setDate={setDate} canRequest={canRequest} setLoggedIn={setLoggedIn} isLessWidth={isLessWidth} visibleMenu={visibleMenu} setVisibleMenu={setVisibleMenu} />
            </div>
