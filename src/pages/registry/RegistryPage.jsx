...
const RegistryPage = ({ setUserData, setLoggedIn }) => {
    ...
    const handleRegistry = async () => {
        if (!companyID || !password || !regKey || !role) {
        ...
        try {
            const response = await authAPI.Register(companyID, password, role, regKey);
    ...
    return (
        <div
            ...
            <motion.div
                ...
                className="w-120 bg-white/90 backdrop-blur-md p-11 rounded-2xl shadow-2xl shadow-gray-400 border border-gray-100"
            >
